...
// Import the MessageMixer module by assigning it to a variable.  This variable will then be used
// to get access to all the properties we defined in the MessageMixer file:
...
function displayMessage() {
  ...
  console.log(MessageMixer.piglatin('This is my pig latin sentence','b'));
  console.log(MessageMixer.palindrome('Christian'));